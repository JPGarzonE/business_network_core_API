...
# Models
from ..models import Certificate, Currency, Product, ProductCertificate, ProductImage
from multimedia.models import Image

# Serializers
from ..serializers import CertificateModelSerializer, CurrencyModelSerializer, ProductSupplierModelSerializer
...
class ProductDetailModelSerializer(serializers.ModelSerializer):
    ...
    supplier = ProductSupplierModelSerializer()
...
class HandleSupplierProductSerializer(serializers.ModelSerializer):
    """Create and update a supplier product"""
    ...
    currency_id = serializers.IntegerField(
        help_text = """Id that determine the currency of the prices in the product. 
            For seeing which currencies are available look the 'currencies/' endpoint."""
    )
